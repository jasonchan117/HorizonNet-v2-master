...
from horizonnet_master.eval_cuboid import prepare_gtdt_pairs
from horizonnet_master.dataset import cor_2_1d
from horizonnet_master.misc import post_proc
...
def test_general(dt_cor_id, gt_cor_id, w, h, losses, gt_path=None):
...
if __name__ == '__main__':
    ...
    for gt_path, dt_path in tqdm(gtdt_pairs, desc='Testing'):
        ...
        test_general(dt_cor_id, gt_cor_id, args.w, args.h, losses, gt_path)
